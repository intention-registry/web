<footer class="footer p-10 bg-base-100 text-base-content">
	<div>
		...
		<a class="link link-hover">Open Source</a>
		<a class="link link-hover">Nostr</a>
	</div>
	<div>
...
<footer class="footer px-10 py-4 border-t bg-base-100 text-base-content border-base-300">
	<div class="items-center grid-flow-col">
		<p>Copyright © 2023 IntentionRegistry - All right reserved.</p>
	</div>
	<div class="md:place-self-center md:justify-self-end">
		<div class="grid grid-flow-col gap-4">
			<a href="https://github.com/intention-registry/web">
				<svg
